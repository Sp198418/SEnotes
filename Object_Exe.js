// Level 0: 
    // 0.1: Creating an object
        // Create an object with the name of a sport
           ...
           // var Basketball = {
            //    player1: ['Paul George', 23, 'points' ], 
             //   player2: ['Tim Duncan', 18, 'points' ],
             //   player3: ['Kyrie irving', 100, 'points' ],
           // }
    ...
    // 0.2: Changing Values
        // Using bracket notation 
          ...
          //  var Basketball = {
            ...
            //console.log(Basketball)
            ///Basketball.item1 = 'Sneakers';
            //Basketball.item2 = 'Shorts';
            //Basketball.item3 = 'Ball'
